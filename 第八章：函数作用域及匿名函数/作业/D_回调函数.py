...
# 回调函数概念：将函数作为参数传递
# 举例
# 定义一个函数x,这个函数的功能是，作为一个中间函数，执行传进来的函数
def x(f):
    print(f)     # <function func at 0x0000019749A5B310> 打印的是函数的内存地址

# def func():
#     print("这个是一个及其简单的函数")
x(lambda : print("这个是一个及其简单的函数"))     # 这个传参就不普通了，这里传参一个函数名，那么像这样传参，这个被当做参数传递的函数，我们称之为回调函数

# 函数名 和 函数名() 是有区别的，函数名是可以代表一个函数，这个代表我们称呼为引用，函数名()是对这个函数去进行使用
