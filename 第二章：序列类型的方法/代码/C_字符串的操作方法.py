...
# sel_str4 = input("请输入一段字符串：")    # 用input语句去接受用户输入的数据，并保存为字符串存变量 sel_str4 中
# print(sel_str4.isupper())   # 查看用户输入的数据中字母是否全是大写

# input是输入语句，请让用户输入一段字符串，并检查是否全是小写
sel_str5 = input("请输入一段字符串：")
print(sel_str5.islower())   # 查看用户输入的数据中字母是否全是小写